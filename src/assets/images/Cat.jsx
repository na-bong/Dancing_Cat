const CatSvg = ({ className }) => (
  ...
  >
    {/* 몸통 */}
    <ellipse cx="100" cy="130" rx="50" ry="40" fill="#FF9800" />

    {/* 머리 */}
    <circle cx="100" cy="70" r="40" fill="#FF9800" />

    {/* 왼쪽 귀 */}
    <polygon points="65,45 75,10 90,40" fill="#FF9800" />
    <polygon points="70,40 77,20 85,38" fill="#FFB74D" />

    {/* 오른쪽 귀 */}
    <polygon points="135,45 125,10 110,40" fill="#FF9800" />
    <polygon points="130,40 123,20 115,38" fill="#FFB74D" />

    {/* 얼굴 무늬 */}
    <ellipse cx="100" cy="75" rx="25" ry="20" fill="#FFE0B2" />
    ...
    {/* 앞발 */}
    <ellipse cx="70" cy="160" rx="12" ry="18" fill="#FF9800" />
    <ellipse cx="130" cy="160" rx="12" ry="18" fill="#FF9800" />

    {/* 발바닥 */}
    <ellipse cx="70" cy="168" rx="8" ry="6" fill="#FFB74D" />
    <ellipse cx="130" cy="168" rx="8" ry="6" fill="#FFB74D" />
    ...
    {/* 배 무늬 */}
    <ellipse cx="100" cy="140" rx="25" ry="20" fill="#FFE0B2" />
